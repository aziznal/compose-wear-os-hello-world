...
android {
    namespace = "com.example.helloworldagain"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.helloworldagain"
        minSdk = 30
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("io.github.raamcosta.compose-destinations:wear-core:$composeDestinations")
